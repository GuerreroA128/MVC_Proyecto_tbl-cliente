        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="/proyecto/view/cliente/index.php">Usuarios</a></li>
                    <li><a class="dropdown-item" href="/proyecto/view/cliente/create.php">Agregar nuevos usuarios</a></li>
                </ul>
                </li>
            </ul>
            </div>
